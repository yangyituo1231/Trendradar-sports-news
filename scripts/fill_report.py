...
SCENE_POOLS = {
    "rain": {
        ...
        "signal": ["防雨防滑需求提升", "轻防护品类升温", "防水鞋服受关注"],
        "action": ["强化防雨防滑陈列", "前置室内运动场景", "用会员活动承接客流"],
    },
    "high_temp": {
    ...
    "kids": {
        ...
        "signal": ["童鞋需求提升", "运动套装受关注", "速干T热度增加"],
        "action": ["强化亲子校园陈列", "做童鞋服装连带", "增加儿童套装展示"],
    },
    "outdoor": {
    ...
    "mall": {
        ...
        "signal": ["连带消费提升", "门口陈列更关键", "客流修复仍需转化"],
        "action": ["加强会员活动", "优化门口堆头", "提升试穿转化"],
    },
}
